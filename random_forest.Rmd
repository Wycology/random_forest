...
```{r data_loading}
data <- iris
str(data) # To check the existing variables and their types.
```

## Partitioning the data

Here, we break down the data into two sets with one part to be used for training/calibrating/building the model and the other part being left for testing the model performance once it is built successfully. Normally, training set should be having more data than the test set, especially when there is limited records of data. But can vary depending on your use case.
