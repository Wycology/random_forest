...
Here, we break down the data into two sets with one part to be used for training/calibrating/building the model and the other being used for testing the model performance. Normally training set should be having more data than the test set. But can vary depending on your use case.
