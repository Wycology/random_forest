...
author: "Wyclife Agumba Oluoch</center>"
...
Building the random forest model using the target variable and all the continuous variables in the data-set.
...
So according to this, it seems Petal.Length and Petal.Width are the top two important variables in predicting Species of iris. Let us plot these individually.
