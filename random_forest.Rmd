...
So according to this, it seems `Petal.Length` and `Petal.Width` are the top two important variables in predicting **Species** of iris. Let us plot these vari individually.
