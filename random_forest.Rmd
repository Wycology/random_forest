...
Here I demonstrate how to use `randomForest` in R to train a model and make prediction over new data. New data here actually has all features that were used in training dataset. Generally, the two sets should be overlapping in values, though not exactly the same.
